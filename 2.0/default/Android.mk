...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.sprd.hardware.power@2.0-impl
...
LOCAL_SHARED_LIBRARIES := \
    ...
    vendor.sprd.hardware.power@2.0
...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.sprd.hardware.power@2.0-service
LOCAL_INIT_RC := vendor.sprd.hardware.power@2.0-service.rc
LOCAL_PROPRIETARY_MODULE := true
